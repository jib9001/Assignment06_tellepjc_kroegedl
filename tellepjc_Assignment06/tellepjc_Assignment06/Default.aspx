    ...
    <table>
        <tr>
            ...
            <td align="right" style="height: 20%; padding-left: 2%">
                ...
                <asp:TextBox ID="tbxDateOfTransaction" runat="server"></asp:TextBox>
                </td>

            <td align="right" style="height: 20%; padding-left: 2%">
                <asp:Label ID="lblTimeOfTransaction" runat="server" Text="Time Of Transaction"></asp:Label>
                <asp:TextBox ID="tbxTimeOfTransaction" runat="server"></asp:TextBox>
                </td>
        </tr>
        ...
        <tr>
             ...
             <td align="right" style="height: 20%; padding-left: 2%">
                ...
                <br />
                 <asp:TextBox ID="tbxPricePerSellableUnitAsMarked" runat="server"></asp:TextBox>
                </td>
        ...
        <tr>
              ...
              <td align="right" style="height: 20%; padding-left: 2%">
                ...
                <br />
                 <asp:TextBox ID="tbxPricePerSellableUnitToTheCustomer" runat="server"></asp:TextBox>
                </td>

              <td align="right" style="height: 20%; padding-left: 2%">
                <asp:Label ID="lblTransactionComment" runat="server" Text="Comments about the transaction"></asp:Label>
                <br />
                 <asp:TextBox ID="tbxTransactionComment" runat="server"></asp:TextBox>
                </td>

              <td align="right" style="height: 20%; padding-left: 2%">
                <asp:Label ID="lblTransactionDetailComment" runat="server" Text="Comments about the transaction detail"></asp:Label>
                <br />
                 <asp:TextBox ID="tbxtransactionDetailComment" runat="server"></asp:TextBox>
                </td>
